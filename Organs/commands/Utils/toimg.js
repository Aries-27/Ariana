...
module.exports={
  ...
  exec(`ffmpeg -i ${media} ${ran}`, (err) => {
      ...
      client.sendMessage(m.from, { image: buffer,caption:'PIKACHU-BOT-2023' }, { quoted: m })
      fs.unlinkSync(ran)
  })
  ...
  await client.sendMessage(m.from, { video: { url: webpToMp4.result, caption: 'PIKACHU-BOT-2023' }, gifPlayback: true }, { quoted: m })
